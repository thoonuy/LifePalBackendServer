...
USER_LOG_PATH = os.path.join(BASE_DIR, "lpscripts/users_log.json")
...
if __name__ == "__main__":
    ...
    print(sleep_rcm.recommend_sleep_times('dev2', 'pass2312', 9, 6.89, 654, "8:32"))
    print(sleep_rcm.recommend_sleep_times('dev2', 'pass2312', 9, 6.89, 654, "11:59"))
